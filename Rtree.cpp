...
//		If OverflowTreatment caused a split of the root, create a new
//		root
//
//		Adjust all covering rectangles in the insertion path such that
//		they are MBRs enclosing then children rectangles
	}
